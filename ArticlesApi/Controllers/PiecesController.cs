...
namespace ArticlesApi.Controllers
{
    ...
    public class PiecesController : ControllerBase
    {
        ...
        public PiecesController(ArticlesApiContext context, IPublishEndpoint publishEndpoint)
        {
            _context = context;
        ...
        {
            return await _context.Piece.Include(a=>a.Article).ToListAsync();
        }
        ...
        public async Task<ActionResult<Piece>> PostPiece(Piece piece)
        {
            ...
            await _publishEndpoint.Publish<Shared.Piece>(new Shared.Piece
            {
